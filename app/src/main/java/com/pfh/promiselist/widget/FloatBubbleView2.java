 ...
 */
public class FloatBubbleView2 extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public FloatBubbleView2(Context context) {
        super(context);
        initThreadAndHolder(context);
    }

    public FloatBubbleView2(Context context, AttributeSet attrs) {
        super(context, attrs);
        initThreadAndHolder(context);
    }

    public FloatBubbleView2(Context context, AttributeSet attrs, int defStyleAttr) {
